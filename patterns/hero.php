...
<section class="wp-block-group hero" style="background-color:#ffffff;color:#0a0a0a;padding-top:6rem;padding-bottom:8rem;padding-left:2rem;padding-right:2rem;">
  ...
  <div class="wp-block-buttons hero-buttons">
    ...
    <div class="wp-block-button">
      <a class="wp-block-button__link has-background" style="background-color:var(--wp--preset--color--accent);color:#000;border-radius:8px;font-weight:600;" href="#proefles">GRATIS PROEFLES</a>
    </div>
    <!-- /wp:button -->

    <!-- wp:button -->
    <div class="wp-block-button">
      <a class="wp-block-button__link has-text-color" style="color:#000;border:2px solid var(--wp--preset--color--accent);border-radius:8px;font-weight:600;" href="/lessen">BEKIJK LESSEN</a>
    </div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
